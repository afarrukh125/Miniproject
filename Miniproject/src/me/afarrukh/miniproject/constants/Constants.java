...
public class Constants {
    ...
    public static final int MAP_WIDTH = 125; //Both this and the height are NOT in terms of pixels. These are actually how many tiles there are in a newly generated map.

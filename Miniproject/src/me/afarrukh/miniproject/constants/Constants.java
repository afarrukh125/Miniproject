...
public class Constants {
    ...
    public static final int MAP_WIDTH = 125; //Both this and the height are NOT in terms of pixels. These are actually how many tileArray there are in a newly generated map.
    public static final int MAP_HEIGHT = 125;
    public static final int numTiles = 5; //This is how many types of tileArray there are
